        ...
        <ul id="sidebarnav" class="pt-4">
          ...
          <li class="sidebar-item">
            <a href="{{route('supplierIndex')}}" class="sidebar-link"
              ...
              ><span class="hide-menu"> Quản lý nhà sản xuất </span></a
            >
          </li>
          <li class="sidebar-item">
          ...
          <li class="sidebar-item">
            <a href="{{route('feedbackIndex')}}" class="sidebar-link"
              ><i class="mdi mdi-note-plus"></i
              ><span class="hide-menu"> Quản lý Comment </span></a
            >
          </li>
          <li class="sidebar-item">
          ...
          <li class="sidebar-item">
            <a href="{{route('discountIndex')}}" class="sidebar-link"
              ><i class="mdi mdi-note-plus"></i
              ><span class="hide-menu"> Quản lý Mã giảm giá </span></a
            >
          </li>
          {{-- <li class="sidebar-item">
          ...
          <li class="sidebar-item">
            <a href="{{route('ReportIndex')}}" class="sidebar-link"
              ><i class="mdi mdi-note-plus"></i
              ><span class="hide-menu"> Phản hồi khách hàng</span></a
            >
          </li>
          {{-- <li class="sidebar-item">
            <a
