...
<main id="main" class="">
	...
	<form action="{{route('ContactpostCreate')}}" method="post"  novalidate="novalidate">
		{{ csrf_field() }}
	<div class="form-ct clear">
	<div class="form-row w50">
	<span ><input type="text" name="name" id="txt_name"value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form_lien_he" id="text-name" aria-required="true" aria-invalid="false" placeholder="Họ và tên" /></span>
	<span class="span-alert" id="error_name">Không được để trống</span>	
</div>
	<div class="form-row w50">
	<span ><input type="email" name="email" id="txt_email"value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form_lien_he" id="email" aria-required="true" aria-invalid="false" placeholder="Email" /></span>
	<span class="span-alert" id="error_email">Không được để trống</span>
	<span class="span-alert" id="error_email1">Email không đúng</span>	
</div>
	<div class="form-row w50">
	<span ><input type="tel" name="phone"  id="txt_phone"value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-required wpcf7-validates-as-tel form_lien_he" id="tel-contact" aria-required="true" aria-invalid="false" placeholder="Số điện thoại" /></span>
	...
	<div class="form-row w50">
	<span ><input type="text" name="address" id="txt_address"value="" size="40" class="wpcf7-form-control wpcf7-text form_lien_he" id="text-address" aria-invalid="false" placeholder="Địa chỉ" /></span>
	<span class="span-alert" id="error_address">Không được để trống</span>	
</div>
	<div class="form-row">
	<span class="wpcf7-form-control-wrap textarea-noidung">
		<textarea id="txt_content" name="content" cols="88" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required form_lien_he" id="textarea-noidung" aria-required="true" aria-invalid="false" placeholder="Lời nhắn">
			</textarea>
			<span class="span-alert" id="error_content">Không được để trống</span>
		</span>
	</div>
	<div class="form-row center-txt align-center" >
	<input type="submit" value="Gửi" id="dangKy" />
	</div>
	</div>
	...
	<script>
		...
		var checkValidation = function (){
		   var flag = kiemtrarong('#txt_address','#error_address') & kiemtrarong('#txt_name','#error_name') & kiemtrarong('#txt_content','#error_content');
			 //Kiểm tra sdt
			...
			//Email
			var flag2 = kiemtrarong('#txt_email','#error_email'); 
			if(!flag2){
