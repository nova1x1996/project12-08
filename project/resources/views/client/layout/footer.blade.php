...
<div class="col col-right medium-6 small-12 large-6"  >
	...
	<div class="col-inner text-right" style="margin-top:20px;"  >


<div class="screen-reader-response"></div>

<form  action="{{route('InforEmail')}}" method="post" style="display:flex;">
	{{ csrf_field() }}
	<input type="email" name="email-dang-ky1">
	<button style="width:200px;color:white;"type="submit">Đăng ký</button>
</form>
...
<h3>LIÊN KẾT</h3>
<ul class="sidebar-wrapper ul-reset"><div class="mona_sidebar_footer"><div class="menu-menu-footer-company-container"><ul id="menu-menu-footer-company" class="menu"><li id="menu-item-656" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-656">
	<a href="{{route('Intro')}}">Giới thiệu</a></li>
<li id="menu-item-944" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-944"><a href="{{route('WatchMen')}}">Đồng hồ nam</a></li>
<li id="menu-item-945" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-945"><a href="{{route('WatchWomen')}}">Đồng hồ nữ</a></li>
<li id="menu-item-946" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-946"><a href="{{route('Blog')}}">Blogs</a></li>
<li id="menu-item-657" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-657"><a href="{{route('Contact')}}">Liên hệ</a></li>
</ul></div></div></ul>
...
<h3>HỖ TRỢ</h3>
<ul class="sidebar-wrapper ul-reset"><div class="menu-menu-support-container"><ul id="menu-menu-support" class="menu"><li id="menu-item-948" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-948"><a href="#">Hướng dẫn mua hàng</a></li>
<li id="menu-item-949" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-949"><a href="#">Hướng dẫn thanh toán</a></li>
<li id="menu-item-951" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-951"><a href="#">Chính sách đổi trả</a></li>
<li id="menu-item-952" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-952"><a href="#">Tư vấn khách hàng</a></li>
</ul></div></ul>
